...
import './App.css';
import manishImage from "./manish.jpg.jpeg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={manishImage} alt="manish" />
          <h3 className="name">Manish</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Manish</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span> Manish </h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Vijayawada</h3>
            <h3> <span> Strengths : </span> Smart Work, Patience </h3>
            <h3> <span> Hobbies: </span> Playing games, Travelling </h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          ...
          <div className="box">
            ...
            <h3>Intermediate</h3>
            <h3>MPC</h3>
            <p style={{ fontSize: '20px' }}>Sarada College</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2021-2025</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> manish669817@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 7989753027 </h3>
